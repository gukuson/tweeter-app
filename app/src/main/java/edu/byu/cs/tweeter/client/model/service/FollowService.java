...
public class FollowService {
    ...
    public void loadMoreFollowees(AuthToken currUserAuthToken, User user, int pageSize, User lastFollowee, PagedTaskObserver<User> observer) {
        GetFollowingTask followingTask = getFollowingTask(currUserAuthToken,
                user, pageSize, lastFollowee, observer);
        BackgroundTaskUtils.runTask(followingTask);
    }


    public GetFollowingTask getFollowingTask(AuthToken authToken, User targetUser, int limit, User lastFollowee, PagedTaskObserver<User> observer) {
        return new GetFollowingTask(authToken, targetUser, limit, lastFollowee, new PagedTaskHandler<>(observer));
    }
//    public GetFollowingTask getFollowingTask(AuthToken authToken, User targetUser, int limit, User lastFollowee, GetFollowingObserver observer) {
