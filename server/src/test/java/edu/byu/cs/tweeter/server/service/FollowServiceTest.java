...
//        request = new GetFollowRequest(authToken, currentUser.getAlias(), 3, null);
//
...
//
//    /**
//     * Verify that the {@link FollowService#getFollowees(edu.byu.cs.tweeter.model.net.request.GetFollowRequest)}
